...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/toJson.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/_@skpm_fs@0.2.6@@skpm/fs/index.js":
/*!********************************************************!*\
  !*** ./node_modules/_@skpm_fs@0.2.6@@skpm/fs/index.js ***!
  \********************************************************/
...
var utils = __webpack_require__(/*! ./utils */ "./node_modules/_@skpm_fs@0.2.6@@skpm/fs/utils.js");
...
/***/ "./node_modules/_@skpm_fs@0.2.6@@skpm/fs/utils.js":
/*!********************************************************!*\
  !*** ./node_modules/_@skpm_fs@0.2.6@@skpm/fs/utils.js ***!
  \********************************************************/
/*! no static exports found */
...
module.exports.fsErrorForPath = function fsErrorForPath(
  ...
  if (typeof shouldBeDir !== "undefined") {
    var isDirectory = __webpack_require__(/*! ./index */ "./node_modules/_@skpm_fs@0.2.6@@skpm/fs/index.js").lstatSync(path).isDirectory();
...
/* harmony import */ var _skpm_fs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @skpm/fs */ "./node_modules/_@skpm_fs@0.2.6@@skpm/fs/index.js");
...
var buffer2pngbase64 = function buffer2pngbase64(buffer) {
  return "data:image/png;base64,".concat(buffer.toString('base64'));
};
var genNormalItem = function genNormalItem(layer) {
  var item = {
    id: layer.id,
    name: layer.name,
    type: layer.type,
...
var genImageItem = function genImageItem(layer) {
  var item = genNormalItem(layer);
  item.url = buffer2pngbase64(sketch_dom__WEBPACK_IMPORTED_MODULE_0___default.a.export(layer, {
    formats: 'png',
    output: false
  }));
  return item;
};
var genGroupItem = function genGroupItem(layer) {
  var item = genNormalItem(layer);
  item.children = [];
  return item;
};
var genTextItem = function genTextItem(layer) {
  var item = genNormalItem(layer);
...
/* harmony default export */ __webpack_exports__["default"] = (function (context) {
  ...
  if (!document) {
    sketch_ui__WEBPACK_IMPORTED_MODULE_1___default.a.message('没有选中的图层');
    return;
  }
  ...
  // 获取当前选中的图层
  var selection = selectedLayers.layers;
  if (selection.length > 1 || selection[0].type !== 'Group') {
    sketch_ui__WEBPACK_IMPORTED_MODULE_1___default.a.alert('选中元素元素未编组', '请将选中的元素编组后再导出为json');
    return;
  }
  ...
  if (savePanel.runModal() == NSFileHandlingPanelOKButton) {
    var fileURL = savePanel.URL().path();
    var readLayers = function readLayers(layers, parent) {
      layers.map(function (layer) {
        if (layer.name.includes("_pic")) {
          //_pic表示转图片
          parent.push(genImageItem(layer));
        } else if (layer.type === 'Group') {
          var groupItem = genGroupItem(layer);
    ...
    coverImage = buffer2pngbase64(sketch_dom__WEBPACK_IMPORTED_MODULE_0___default.a.export(selection[0], {
      formats: 'png',
      output: false
    }));
    ...
    // 写入文件
    Object(_skpm_fs__WEBPACK_IMPORTED_MODULE_2__["writeFileSync"])(fileURL, jsonStr);

    // 通知用户文件已保存
    sketch_ui__WEBPACK_IMPORTED_MODULE_1___default.a.message('导出为星河JSON成功');
  }
});
...
//# sourceMappingURL=__toJson.js.map